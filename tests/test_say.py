...
@pytest.mark.asyncio
async def test_say_n3(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_n2(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_n1(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p0(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p1(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p2(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p3(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_default(ctx: commands.Context[commands.Bot], userdb_load: MagicMock | AsyncMock):
