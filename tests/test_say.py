...
@pytest.mark.asyncio
async def test_say_n3(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_n2(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_n1(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p0(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p1(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p2(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_p3(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
...
@pytest.mark.asyncio
async def test_say_default(ctx: BotContext, userdb_load: MagicMock | AsyncMock):
