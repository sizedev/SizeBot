...
all_stats = {s.key: s for s in [
    Stat("nickname",                "Nickname",                 "{nickname}",                                                                       "{nickname}",                                                                                                                                               type=str,       userkey="nickname"),
    ...
    Stat("walkperhour",             "Walk Per Hour",            "{nickname} walks **{walkperhour:,.3mu} per hour**.",                               emojis.walk + "{walkperhour:,.1M} per hour / {walkperhour:,.1U} per hour",                              is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_WALKPERHOUR * s["averagescale"]),
    Stat("runperhour",              "Run Per Hour",             "{nickname} runs **{runperhour:,.3mu} per hour**.",                                 emojis.run + " {runperhour:,.1M} per hour / {runperhour:,.1U} per hour",                                is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_RUNPERHOUR * s["averagescale"]),
    Stat("swimperhour",             "Swim Per Hour",            "{nickname} swims **{swimperhour:,.3mu} per hour**.",                               emojis.climb + " {swimperhour:,.1M} per hour / {swimperhour:,.1U} per hour",                            is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_SWIMPERHOUR * s["averagescale"]),
    Stat("climbperhour",            "Climb Per Hour",           "{nickname} climbs **{climbperhour:,.3mu} per hour**.",                             emojis.crawl + " {climbperhour:,.1M} per hour / {climbperhour:,.1U} per hour",                          is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_CLIMBPERHOUR * s["averagescale"]),
    Stat("crawlperhour",            "Crawl Per Hour",           "{nickname} crawls **{crawlperhour:,.3mu} per hour**.",                             emojis.swim + " {crawlperhour:,.1M} per hour / {crawlperhour:,.1U} per hour",                           is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_CRAWLPERHOUR * s["averagescale"]),
    Stat("driveperhour",            "Drive Per Hour",           "{nickname} drives **{driveperhour:,.3mu} per hour**.",                             emojis.drive + " {driveperhour:,.1M} per hour / {driveperhour:,.1U} per hour",                          is_shown=False,                                                                 power=1,    type=SV,                                default_from=lambda s: AVERAGE_DRIVEPERHOUR),
    Stat("spaceshipperhour",        "Spaceship Per Hour",       "{nickname} flys at spaceship at **{spaceshipperhour:,.3mu} per hour**.",           emojis.spaceship + " {spaceshipperhour:,.1M} per hour / {spaceshipperhour:,.1U} per hour",              is_shown=False,                                                                 power=1,    type=SV,                                default_from=lambda s: AVERAGE_SPACESHIPPERHOUR),
    Stat("walksteplength",          "Walk Step Length",         "{nickname} takes **{walksteplength:,.3mu}** strides while walking.",               "{walksteplength:,.3mu}",                                                                               is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_WALKPERHOUR * s["averagescale"] / WALKSTEPSPERHOUR),
    Stat("runsteplength",           "Run Step Length",          "{nickname} takes **{runsteplength:,.3mu}** strides while runing.",                 "{runsteplength:,.3mu}",                                                                                is_shown=False,                         requires=["averagescale"],              power=1,    type=SV,                                default_from=lambda s: AVERAGE_RUNPERHOUR * s["averagescale"] / RUNSTEPSPERHOUR),
    Stat("climbsteplength",         "Climb Step Length",        "{nickname} takes **{climbsteplength:,.3mu}** strides while climbing.",             "{climbsteplength:,.3mu}",                                                                              is_shown=False,                         requires=["height"],                    power=1,    type=SV,                                default_from=lambda s: s["height"] * Decimal(1 / 2.5)),
    Stat("crawlsteplength",         "Crawl Step Length",        "{nickname} takes **{crawlsteplength:,.3mu}** strides while crawling.",             "{crawlsteplength:,.3mu}",                                                                              is_shown=False,                         requires=["height"],                    power=1,    type=SV,                                default_from=lambda s: s["height"] * Decimal(1 / 2.577)),
    Stat("swimsteplength",          "Swim Step Length",         "{nickname} takes **{swimsteplength:,.3mu}** strides while swiming.",               "{swimsteplength:,.3mu}",                                                                               is_shown=False,                         requires=["height"],                    power=1,    type=SV,                                default_from=lambda s: s["height"] * Decimal(6 / 7)),
    ...
    Stat("footarea",                "Foot Area",                "{nickname}'s foot would cover **{footarea:,.3mu}** of area.",                      "{footarea:,.3mu}",                                     is_shown=False,                                 requires=["footlength", "footwidth"],   power=2,    type=AV,                                default_from=lambda s: s["footlength"] * s["footwidth"]),
    Stat("fingertiparea",           "Fingertip Area",           "{nickname}'s fingertip would cover **{fingertiparea:,.3mu}** of area.",            "{fingertiparea:,.3mu}",                                is_shown=False,                                 requires=["fingertiplength"],           power=2,    type=AV,                                default_from=lambda s: s["fingertiplength"] * s["fingertiplength"]),
