...
all_stats = {s.key: s for s in [
    ...
    Stat("viewscale",               "Viewscale",                lambda s: format_scale(s['viewscale']),                                             lambda s: format_scale(s['viewscale']),                                                             requires=["scale"],                     power=0,    type=Decimal,   userkey="scale",        default_from=lambda s: 1 / s["scale"]),
