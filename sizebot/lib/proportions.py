...
all_stats = {s.key: s for s in [
    ...
    Stat("shoesize",                "Shoe Size",                "{nickname}'s shoe size is **{shoesize}**.",                                        "{shoesize}",                                           is_shown=False,                                 requires=["footlength", "gender"],                  type=str,                               default_from=(lambda s: format_shoe_size(s["footlength"], s["gender"])), tags = ["foot"]),
