...
all_stats = [
    ...
    StatDef("shoesize",                "Shoe Size",                     "{nickname}'s shoe size is **{shoesize}**.",                                        "{shoesize}",                                                                                           is_shown=False,                                          requires=["footlength", "gender"],      power=1,    type=str,                               value=(lambda v: format_shoe_size(v["footlength"], v["gender"])),                tags=["foot"]),
