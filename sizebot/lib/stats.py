...
all_stats = [
    ...
    StatDef("scale",                   "Scale",                         lambda s: format_scale(s['scale'].value),                                           lambda s: format_scale(s['scale'].value),                                                                                                                                                                            type=Decimal,   userkey="scale"),
    StatDef("viewscale",               "Viewscale",                     lambda s: format_scale(s['viewscale'].value),                                       lambda s: format_scale(s['viewscale'].value),                                                           is_shown=False,                                          requires=["scale"],                                 type=Decimal,                           value=lambda v: 1 / v["scale"]),
    ...
    StatDef("shoesize",                "Shoe Size",                     "{nickname}'s shoe size is **{shoesize}**.",                                        "{shoesize}",                                                                                           is_shown=False,                                          requires=["footlength", "gender", "scale"],         type=str,                               value=(lambda v: format_shoe_size(v["footlength"] * v["scale"], v["gender"])),   tags=["foot"]),
    ...
    StatDef("shoulderheight",          "Shoulder Height",               "{nickname}'s shoulder is **{shoulderheight:,.3mu}** high.",                        "{shoulderheight:,.3mu}",                                                                               is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] * Decimal(0.818),                                    tags=["height"]),
    StatDef("waistheight",             "Waist Height",                  "{nickname}'s waist is **{waistheight:,.3mu}** high.",                              "{waistheight:,.3mu}",                                                                                  is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] * Decimal(0.530),                                    tags=["height"]),
    StatDef("kneeheight",              "Knee Height",                   "{nickname}'s knee is **{kneeheight:,.3mu}** high.",                                "{kneeheight:,.3mu}",                                                                                   is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] * Decimal(0.285),                                    tags=["height"]),
    StatDef("ankleheight",             "Ankle Height",                  "{nickname}'s ankle is **{ankleheight:,.3mu}** high.",                              "{ankleheight:,.3mu}",                                                                                  is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] / 17,                                                tags=["height"]),
    StatDef("toeheight",               "Toe Height",                    "{nickname}'s toe is **{toeheight:,.3mu}** thick.",                                 "{toeheight:,.3mu}",                                                                                    is_shown=lambda s: s["scale"].value > IS_VERY_LARGE,     requires=["height"],                    power=1,    type=SV,                                value=(lambda v: v["height"] / 65),                                              tags=["height"]),
    StatDef("height+",                 lambda s: s['height'].title,     "", lambda s: f"{s['height'].body}" + f"\n*{s['scale'].body} scale*" + (f"\n{s['visibility'].body}" if s['visibility'].is_shown else ""),          z=1),
