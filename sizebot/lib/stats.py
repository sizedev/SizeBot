...
all_stats = [
    ...
    StatDef("hairlength",
            ...
            string="{nickname}'s {hairname} is **{hairlength:,.3mu}** long.",
            body="{hairlength:,.3mu}",
    ...
    StatDef("footlength",
            ...
            string="{nickname}'s {footname} is **{footlength:,.3mu}** long.",
            body="{footlength:,.3mu}",
            is_shown=False,
            requires=["height"],
            power=1,
    ...
    StatDef("footwidth",
            ...
            string="{nickname}'s {footname} is **{footwidth:,.3mu}** wide.",
            body="{footwidth:,.3mu}",
            requires=["footlength"],
            power=1,
            type=SV,
    ...
    StatDef("hairwidth",
            ...
            string="{nickname}'s {hairname} is **{hairwidth:,.3mu}** wide.",
            body="{hairwidth:,.3mu}",
            is_shown=lambda s: s["scale"].value > IS_VERY_LARGE,
            requires=["height"],
            power=1,
    ...
    StatDef("swimperhour",
            ...
            body=emojis.climb + " {swimperhour:,.1M} per hour / {swimperhour:,.1U} per hour",
            is_shown=False,
            requires=["averagescale"],
            power=1,
            type=SV,
    ...
    StatDef("climbperhour",
            ...
            body=emojis.crawl + " {climbperhour:,.1M} per hour / {climbperhour:,.1U} per hour",
            is_shown=False,
            requires=["averagescale"],
            power=1,
            type=SV,
    ...
    StatDef("crawlperhour",
            ...
            body=emojis.swim + " {crawlperhour:,.1M} per hour / {crawlperhour:,.1U} per hour",
            is_shown=False,
            requires=["averagescale"],
            power=1,
            type=SV,
    ...
    StatDef("footarea",
            title="{footname} Area",
            string="{nickname}'s {footname} would cover **{footarea:,.3mu}** of area.",
            body="{footarea:,.3mu}",
            is_shown=False,
