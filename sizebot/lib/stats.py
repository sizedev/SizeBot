...
all_stats = [
    ...
    StatDef("shoulderheight",          "Shoulder Height",               "{nickname}'s shoulder is **{shoulderheight:,.3mu}** high.",                        "{shoulderheight:,.3mu}",                                                                               is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] * 0.818,                                             tags=["height"]),
    StatDef("waistheight",             "Waist Height",                  "{nickname}'s waist is **{waistheight:,.3mu}** high.",                              "{waistheight:,.3mu}",                                                                                  is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] * 0.530,                                             tags=["height"]),
    StatDef("kneeheight",              "Knee Height",                   "{nickname}'s knee is **{kneeheight:,.3mu}** high.",                                "{kneeheight:,.3mu}",                                                                                   is_shown=False,                                          requires=["height"],                    power=1,    type=SV,                                value=lambda v: v["height"] * 0.285,                                             tags=["height"]),
