...
all_stats = [
    ...
    StatDef("hairlength",
            title="Hair Length",
            string="{nickname}'s hair is **{hairlength:,.3mu}** long.",
            body="{hairlength:,.3mu}",
    ...
    StatDef("footlength",
            title="Foot Length",
            string="{nickname}'s foot is **{footlength:,.3mu}** long.",
            body="{footlength:,.3mu}",
            is_shown=False,
            requires=["height"],
            power=1,
    ...
    StatDef("hairwidth",
            title="Hair Width",
            string="{nickname}'s hair is **{hairwidth:,.3mu}** wide.",
            body="{hairwidth:,.3mu}",
            is_shown=lambda s: s["scale"].value > IS_VERY_LARGE,
            requires=["height"],
            power=1,
    ...
    StatDef("footarea",
            title="Foot Area",
            string="{nickname}'s foot would cover **{footarea:,.3mu}** of area.",
            body="{footarea:,.3mu}",
            is_shown=False,
    ...
    StatDef("weight+",
            ...
            z=2),
    StatDef("footlength+",
            title=lambda s: "[FOOTNAME] length",
            string="",
