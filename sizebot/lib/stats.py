...
all_stats = [
    ...
    StatDef("scale",                   "Scale",                         lambda s: format_scale(s['scale'].value),                                           lambda s: format_scale(s['scale'].value),                                                                                                                                                                power=1,    type=Decimal,   userkey="scale"),
    ...
    StatDef("shoesize",                "Shoe Size",                     "{nickname}'s shoe size is **{shoesize}**.",                                        "{shoesize}",                                                                                                                                                    requires=["footlength", "gender"],                  type=str,                               value=(lambda v: format_shoe_size(v["footlength"], v["gender"])),                tags=["foot"]),
