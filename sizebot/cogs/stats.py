...
class StatsCog(commands.Cog):
    ...
    def compare_users(self, user1tag, user1, user2tag, user2):
        ...
        return (
            ...
            f"{printtab}Foot Length: {bigtosmallfoot} / {bigtosmallfootUSA} ({fancyFormat(bigtosmallshoe)})\n"
            ...
            f"{printtab}Foot Length: {smalltobigfoot} / {smalltobigfootUSA} ({fancyFormat(smalltobigshoe)})\n"
    ...
    def user_stats(self, usertag, user1):
        ...
        return (
            ...
            f"Foot Length: {footheight_m} / {footheight_u} ({fancyFormat(shoesize)})\n"
