...
- Added `&statsso <from> <to> [user/height]`.
    ...
    - Example: `&statsso 20ft 5mi` gets your stats for if 2ft appeared to be 5mi from your perspective.
- Added `&statso <from> <to> <stat> [user/height]`.
    - Get a stat for if `from` looked to be `to` to you.
    - Example: `&statso 20ft 5mi foot` gets your foot length for if 2ft appeared to be 5mi from your perspective.
- Added `&scaled <object...>`.
