...
- Added a new command, `&lookat`, which allows you to use Macrovision to visually compare multiple people. YOu can add as many people as you want, so long as they are all SizeBot users.
