...
Yes I know it's 2AM, I'm sorry.

## Additions
- Added `shrinkray` and `growthray`.
    - Used like `shrinkray/growthray [1-10] @User`
    - Shrinks/grows the user, the higher the number the stronger the blast.
    - The user must have `toggleallowothers` on.
